...
chat_history = []  # Lưu trữ các tin nhắn và phản hồi trước đó
...
def chat():
    ...
    if request.method == "POST":
        ...
        try:
            ...
            # Tạo mô hình Generative AI từ Google Gemini
            model = genai.GenerativeModel(
                model_name="gemini-2.0-flash-exp",  # Hoặc mô hình bạn muốn sử dụng
            ...
            # Xử lý phản hồi từ Google Gemini
            bot_reply = response.text.strip()
            # Lưu tin nhắn người dùng và phản hồi của bot vào chat history
            chat_history.append({"user_message": user_message, "bot_reply": bot_reply})
        except Exception as e:
